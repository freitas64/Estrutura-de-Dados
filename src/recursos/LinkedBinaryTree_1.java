 ...
 * @param <T>
 */
public class LinkedBinaryTree_1<T> implements BinaryTreeADT<T> 
{
   ...
   //================================================================
   public LinkedBinaryTree_1 (T element) 
   {
      count = 1;
   ...
   //================================================================
   public LinkedBinaryTree_1 (T element, LinkedBinaryTree_1<T> leftSubtree,
                                 LinkedBinaryTree_1<T> rightSubtree) 
   {
   ...
   public Iterator<T> iteratorLevelOrder() 
   {
      ...
      while (! nodes.isEmpty()) 
	 {
          try {
              ...
              Logger.getLogger(LinkedBinaryTree_1.class.getName()).log(Level.SEVERE, null, ex);
          }
